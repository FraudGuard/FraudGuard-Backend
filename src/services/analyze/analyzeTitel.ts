...
export const analyzeTitel = (ad: AdsFromEbaySchema, resultingAd: AdsSchema) =>
  new Promise((resolve, reject) => {
    try {
      ...
      const wordListNeu_gegenteil = ["not new","nicht neu", "ausgepackt","benutzt"];
      ...
      const wordListOvp_gegenteil = ["nicht ovp", "nicht originalverpackt", "nicht original", 
      ...
      const wordListVerschweißt_gegenteil = ["nicht verschweißt", "nicht versiegelt", "keine Versiegelung",
                                            "kein Siegel"]
      ...
      const wordListGebraucht = ["gebraucht", "wie neu", "neuwertig", "aufgebaut","benutzt", 
                                "selten genutzt", "selten benutzt", "alt","gebrauchsspuren"]
      const wordListGebraucht_gegenteil = ["nicht gebraucht", "nicht aufgebaut", "nicht benutzt",
      ...
      const wordListTausche_gegenteil = ["nicht tausche", "kein tauschangebot", "kein tausch"]
      ...
      const wordListSuche_gegenteil = ["keine suche","keine suchanzeige", "nicht gesucht"]
      ...
      // Merkmal Sammlung
      const wordListSammlung = ["sammlerauflösung","sammlung","sammlungsauflösung","sammleraufloesung",
                                "sammlungsaufloesung"]
      const wordListSammlung_gegenteil = ["keine sammlerauflösung", "keine sammlung", " keine sammlungsauflösung",
                                          "keine sammleraufloesung", "keine sammlungsaufloesung"]
